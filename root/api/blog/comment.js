    ...
    Mongo.open(function(db) {
      db.collection('blog_comment').insertOne({
        ...
        if (err) {
          ...
          db.collection('blog_comment').estimatedDocumentCount({
            "blogid": ObjectID(post.blogid)
          }, function(err, count) {
            db.collection('blog').updateOne({
              _id: ObjectID(post.blogid)
            }, {
              $set: {
                comment: count
              }
      ...
      if (post.replayid) {
        db.collection('blog_comment').find({
          ...
          sendMsg({
            ...
            html: `<div style="BORDER: #666666 1px solid; MARGIN: 10px auto 0px; WIDTH: 702px; FONT-FAMILY: 微软雅黑, Arial; COLOR: #111; FONT-SIZE: 12px; -moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px"> <div style="WIDTH: 100%; BACKGROUND: #666666; HEIGHT: 60px; COLOR: white; -moz-border-radius: 6px 6px 0 0; -webkit-border-radius: 6px 6px 0 0; -khtml-border-radius: 6px 6px 0 0; border-radius: 6px 6px 0 0"> <span style="LINE-HEIGHT: 60px; HEIGHT: 60px; MARGIN-LEFT: 30px; FONT-SIZE: 12px">您在 <a style="COLOR: #00bbff; FONT-WEIGHT: 600; TEXT-DECORATION: none" href="https://www.zhuwenlong.com" target="_blank">朱文龙的自留地</a> 上的留言有新回复啦！</span> </div> <div style="MARGIN: 0px auto; WIDTH: 90%"> <p>Mofei, 您好!</p> <p>您曾在 <a href="https://www.zhuwenlong.com/message/${post.blogid}" target="_blank">朱文龙的自留地</a> 的留言，${post.name} 给您的回复如下: </p> <p style="BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; PADDING-BOTTOM: 20px; BACKGROUND-COLOR: #eee; MARGIN: 15px 0px; PADDING-LEFT: 20px; PADDING-RIGHT: 20px; BORDER-TOP: #ddd 1px solid; BORDER-RIGHT: #ddd 1px solid; PADDING-TOP: 20px">${message}</p> <p>您可以点击 <a style="COLOR: #00bbff; TEXT-DECORATION: none" href="https://www.zhuwenlong.com/blog/${post.blogid}" target="_blank">查看回复的完整內容</a> </p> <p>欢迎再次光临 <a style="COLOR: #00bbff; TEXT-DECORATION: none" href="https://www.zhuwenlong.com" target="_blank">朱文龙的自留地</a> </p> <p>(此邮件由系统自动发出, 请勿回复.)</p> </div></div>`
          });
        })
      } else {
        sendMsg({
          ...
          subject: '新留言',
          html: `<div style="BORDER: #666666 1px solid; MARGIN: 10px auto 0px; WIDTH: 702px; FONT-FAMILY: 微软雅黑, Arial; COLOR: #111; FONT-SIZE: 12px; -moz-border-radius: 8px; -webkit-border-radius: 8px; -khtml-border-radius: 8px; border-radius: 8px"> <div style="WIDTH: 100%; BACKGROUND: #666666; HEIGHT: 60px; COLOR: white; -moz-border-radius: 6px 6px 0 0; -webkit-border-radius: 6px 6px 0 0; -khtml-border-radius: 6px 6px 0 0; border-radius: 6px 6px 0 0"> <span style="LINE-HEIGHT: 60px; HEIGHT: 60px; MARGIN-LEFT: 30px; FONT-SIZE: 12px">您在 <a style="COLOR: #00bbff; FONT-WEIGHT: 600; TEXT-DECORATION: none" href="https://www.zhuwenlong.com" target="_blank">朱文龙的自留地</a> 上的留言有新回复啦！</span> </div> <div style="MARGIN: 0px auto; WIDTH: 90%"> <p>Mofei, 您好!</p> <p>您曾在 <a href="https://www.zhuwenlong.com/message/" target="_blank">朱文龙的自留地</a> 的留言，${post.name} 给您的回复如下: </p> <p style="BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; PADDING-BOTTOM: 20px; BACKGROUND-COLOR: #eee; MARGIN: 15px 0px; PADDING-LEFT: 20px; PADDING-RIGHT: 20px; BORDER-TOP: #ddd 1px solid; BORDER-RIGHT: #ddd 1px solid; PADDING-TOP: 20px">${post.content}</p> <p>您可以点击 <a style="COLOR: #00bbff; TEXT-DECORATION: none" href="https://www.zhuwenlong.com/blog/${post.blogid}" target="_blank">查看回复的完整內容</a> </p> <p>欢迎再次光临 <a style="COLOR: #00bbff; TEXT-DECORATION: none" href="https://www.zhuwenlong.com" target="_blank">朱文龙的自留地</a> </p> <p>(此邮件由系统自动发出, 请勿回复.)</p> </div></div>`
        });
      }
    })
  });
