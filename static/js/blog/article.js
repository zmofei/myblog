...
function insertMsg(data) {
    var blockTemp = '<div class="commend-user"><div class="commend-avatar"> <img src="{{avatar}}"></div><div class="commend-info"><div class="commend-name">{{name}}<div class="commend-time">刚刚</div></div></div></div><div class="commend-text">{{content}}</div>';
